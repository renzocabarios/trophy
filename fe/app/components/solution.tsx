    ...
    <div className="text-center py-16 px-20 flex flex-col items-center bg-gradient-to-b from-[#a88a4a] to-[#594535]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-5">
        ...
        <div className="bg-[rgba(60,60,60,0.6)] rounded-xl p-6 shadow-md hover:shadow-lg hover:scale-[1.05] transition-all text-left">
          <img src="/path/to/key-icon.png" alt="Join Giveaways Icon" className="w-20 h-20 mb-4 mx-auto" />
        ...
        {/* Feature 2 */}
        <div className="bg-[rgba(60,60,60,0.6)] rounded-xl p-6 shadow-md hover:shadow-lg hover:scale-[1.05] transition-all text-left">
          <img src="/path/to/wallet-icon.png" alt="Connect Wallet Icon" className="w-20 h-20 mb-4 mx-auto" />
        ...
        {/* Feature 3 */}
        <div className="bg-[rgba(60,60,60,0.6)] rounded-xl p-6 shadow-md hover:shadow-lg hover:scale-[1.05] transition-all text-left">
          <img src="/path/to/gift-icon.png" alt="Create Giveaway Icon" className="w-20 h-20 mb-4 mx-auto" />
        ...
        <div className="bg-[rgba(60,60,60,0.6)] rounded-xl p-6 shadow-md hover:shadow-lg hover:scale-[1.05] transition-all text-left">
          <img src="/path/to/chain-icon.png" alt="Solana Integration Icon" className="w-20 h-20 mb-4 mx-auto" />
          <h3 className="text-xl font-bold mb-2 text-white">Solana Actions BLINKS Integration</h3>
          <p className="text-sm leading-relaxed text-gray-300">
        ...
        <div className="bg-[rgba(60,60,60,0.6)] rounded-xl p-6 shadow-md hover:shadow-lg hover:scale-[1.05] transition-all text-left">
          <img src="/path/to/gear-icon.png" alt="Automated Raffle System Icon" className="w-20 h-20 mb-4 mx-auto" />
          <h3 className="text-xl font-bold mb-2 text-white">Automated Raffle System</h3>
          <p className="text-sm leading-relaxed text-gray-300">
            Win with certainty.
          </p>
        </div>
